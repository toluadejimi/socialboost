...
Route::get('verify',  [PaymentController::class,'verify_payment']);
...
Route::middleware('Maintenance')->group(function () {
    ...
    Route::group(['middleware' => ['auth'], 'prefix' => 'user', 'as' => 'user.'], function () {
        ...
        Route::middleware('userCheck')->group(function () {
            ...
            Route::post('fund-money', 'HomeController@fund_now')->name('fundMoney');


            Route::post('add-fund', 'PaymentController@addFundRequest')->name('addFund.request');
            Route::get('resolve-page', 'PaymentController@resolve')->name('resolve.funds');
            Route::post('resolve-now', 'PaymentController@resolveNow')->name('reslovenow');

            Route::any('fund-manual-now',  [PaymentController::class,'fund_manual_now']);
            Route::any('confirm-pay',  [PaymentController::class,'confirm_pay']);
