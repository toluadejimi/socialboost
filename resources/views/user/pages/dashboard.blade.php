                            ...
                            <table class="table  table-hover table-striped " id="service-table">
                                ...
                                @foreach($transactions as $transaction)
                                    <tr>
                                        ...
                                        <span
                                            class="font-weight-bold text" N {{($transaction->trx_type) ? 'success': 'danger'}}">NGN {{($transaction->trx_type == "+")}}{{getAmount($transaction->amount, config('basic.fraction_number'))}}</span>
                                        </td>
